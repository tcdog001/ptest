...
HI_S32 HIADP_OSD_FillCCRect(HI_HANDLE hSurface, HI_RECT_S *pstRect, HI_U32 u32Color)
{
    OSD_CHECK_INIT();

    return g_om->FillCCRect(hSurface, pstRect, u32Color);
}

HI_S32 HIADP_OSD_DrawCCText(HI_HANDLE hSurface, HI_RECT_S *pstRect, HI_CHAR *pTest,HIADP_CCTEXT_ATTR_S * pstAttr)
{
    OSD_CHECK_INIT();
    ...
    return g_om->DrawCCText(hSurface, pstRect, pTest,&pstCCTextAtrr);
} 
...
HI_S32 HIADP_OSD_CCBlit(HI_HANDLE hSrcSurface, HI_RECT_S *pstSrcRect, HI_RECT_S *pstDstRect)
{
    OSD_CHECK_INIT();
    
    return g_om->CCBlit(hSrcSurface, pstSrcRect, pstDstRect);
}

HI_S32 HIADP_OSD_CaptionDrawBitmap(HI_HANDLE hSrcSurface, HI_U8 *bitmap,HI_RECT_S *pstSrcRect,HI_RECT_S *pstDstRect)
{
    OSD_CHECK_INIT();
    
    return g_om->CaptionDrawBitmap(hSrcSurface, bitmap,pstSrcRect,pstDstRect);
}
