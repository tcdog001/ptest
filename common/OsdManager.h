...
public:
    ...
    HI_S32 FillCCRect(HI_HANDLE hSurface, HI_RECT_S *pstRect, HI_U32 u32Color);
    HI_S32 DrawCCText(HI_HANDLE hSurface, HI_RECT_S *pstRect, HI_CHAR *pText,CCTEXT_ATTR_S * pstAttr);
    HI_S32  GetCCTextSize(HI_CHAR* pTest,HI_S32 *pWidth, HI_S32 *pHeigh );
    HI_S32 CCBlit(HI_HANDLE hSrcSurface, HI_RECT_S *pstSrcRect, HI_RECT_S *pstDstRect);
    HI_S32 CaptionDrawBitmap(HI_HANDLE hSurface, HI_U8 *bitmapBuffer,HI_RECT_S *pstSrcRect,HI_RECT_S *pstDstRect);
};
