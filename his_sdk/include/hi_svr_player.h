...
/**
\brief Register a file and subtitle DEMUX object. This interface is not supported now.CNcomment:使用对象的方式注册文件解析器，该接口当前不支持CNend
\attention \n
This interface must be called after the ::HI_SVR_PLAYER_Init interface is called.
...
\retval ::HI_SUCCESS The object is registered successfully.  CNcomment:注册成功CNend
\retval ::HI_FAILURE The object fails to be registered. CNcomment:注册失败CNend
...
/** CNcomment:用户直接调用HI_SVR_FORMAT_Open()打开媒体文件时需要指定的参数*/
