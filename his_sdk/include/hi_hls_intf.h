...
\endcode
*/
HI_S32 HI_Protocol_HLS_Create(HI_HANDLE* hlsHandle, TsMediaInfo* pAttr);
...
\endcode
*/
HI_S32 HI_Protocol_HLS_WriteTsFrame(HI_HANDLE hlsHandle, TsFrameInfo* pFrameInfo);
...
\endcode
*/
HI_S32 HI_Protocol_HLS_GetTsFileBySeq(HI_HANDLE hlsHandle, HI_S32 nSeq, TsFileInfo* pfile);
...
\endcode
*/
HI_S32 HI_Protocol_HLS_SetAttr(HI_HANDLE hlsHandle, TsMediaInfo* pAttr);
