...
typedef  HI_S32 (*Http_Req_Handler_Callback)(HI_S32 socket, HI_CHAR* pHttpReq, HI_S32  ReqLen, HI_VOID* pUserData, HI_S32 dataLen);
...
HI_VOID HTTP_Protocol_GetReplyHeader(HI_S32 statusCode, HI_S32 contentLen,
    HI_CHAR* pContentType, HI_CHAR* pEtag, HI_CHAR* pHeader);
