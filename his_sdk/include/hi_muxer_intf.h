...
typedef struct tagHI_MuxerInfo_S
{
    ...
    HI_S32 (*MuxerCreate)(HI_HANDLE* hMuxerHandle,HI_U32 muxerType,Transcoder_MuxerAttr* muxerAttr);     /**<muxer create*//**<CNcomment:muxer 创建接口 */
    HI_S32 (*MuxerDestroy)(HI_HANDLE phHandle); /**<muxer destroy*//**<CNcomment:muxer destroy接口 */
    HI_S32 (*MuxerGetHeader)(HI_HANDLE hMuxerHandle,HI_CHAR* pTAGFrame,HI_S32* ps32Len);     /**<muxer getheader*//**<CNcomment:muxer 获取封装头接口 */
    HI_S32 (*DoMuxer)(HI_HANDLE hMuxerHandle,HI_CHAR* pTAGFrame,HI_S32* ps32Len,TRANSCODER_STRAM* pstTranFrame);    /**<muxer domux*//**<CNcomment:muxer 封装接口 */
    HI_S32 (*setPrivate)(HI_HANDLE hMuxerHandle,HI_VOID* stAttr,HI_S32 s32Len); /**<muxer setprivate*//**<CNcomment:muxer 设置私有属性集接口 */
