...
/**
\brief Sets mute or unmute of All Track. CNcomment:设置所有音频Track 静音功能 CNend
\attention \n
...
/**
\brief Gets mute status of an audio player. CNcomment:获取音频Track 静音状态 CNend
\attention \n
...
/**
\brief Obtains the L/R channel weight of snd cast. CNcomment:获取音频Cast左右声道权重 CNend
\attention \n
